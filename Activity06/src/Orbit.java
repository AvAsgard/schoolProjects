...
public class Orbit extends JPanel
{
	...
	private final ImageIcon CAR_ICON = new ImageIcon("flyingcar.png");
	...
	public void paintComponent(Graphics g)
	{
		...
		int orbitRadius = (int)(earthRadius*2);
		...
		int objectRadius = earthRadius/12;
		...
		int objectX = earthX +(int) (orbitRadius*Math.cos(Math.toRadians(orbitTheta)));
		int objectY = earthY +(int) (orbitRadius*Math.sin(Math.toRadians(orbitTheta)));
	
		
		// TODO: Draw your object as an oval with a random color.
		
		//g.setColor(Color.GREEN);
		//g.drawOval(objectX-objectRadius, objectY-objectRadius, objectRadius*2, objectRadius*2);
		
		
		g.drawImage(CAR_ICON.getImage(), objectX-objectRadius, objectY-objectRadius, objectRadius*2, objectRadius*2, null);
